...
\begin{tikzpicture}
   ...
   \begin{axis}[
     width=0.8\textwidth,
     grid,
     xlabel={prob. Dealer goes to {\color{GrassGreen} Streets} ($d$)},
...
\begin{frame}{Graph Best Response functions}
 \begin{tikzpicture}
   ...
   \begin{axis}[
     width=0.8\textwidth,
     grid,
     xlabel={\color{GrassGreen} prob. Police play Streets ($p$)},
     ylabel={\color{GrassGreen} prob. drug dealer goes Streets ($d$)},
     xmin=0, xmax=1.0,
     ymin=0, ymax=1.0,
     xtick={0,.1,...,1.0},
     ytick={0,.1,...,1.0},
...
\begin{itemize}
  ...
  $3/5 \ {\color{GrassGreen} \leq} \ q$.  % this was a typo originally
\end{itemize}
