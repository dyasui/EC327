...
## *Tentative* Schedule
Subject to change. The topics before the midterm are more certain, but depending on time and interest there are a few possibilities of what we will cover in the second half of the class.

## Topics
 1. Intro, Rationality & Preferences
 ...
 5. Signaling Games/Imperfect Information$^*$
 6. Repeated Games
...
## Problem Sets
You will practice what we learn in class on independently by solving 
a few problems that are similar to what you saw in lectures.
...
:::{.incremental}
  ...
  * [Final]{.hi}
    ...
    + Covers everything we learned in the quarter
:::
