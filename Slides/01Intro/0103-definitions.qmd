...
::: {.incremental}
  ...
  * Economics is the study of [choice]{.hi} under [constraints]{.hii}   
  * We use the term [*strategy*]{.hi} to distinguish socially-dependent choices from simple optimization problems
  
A [*game*]{.hi} is a type of problem featuring multiple agents, called [players]{.hi},
  
  * in which their optimal choice [depends on the choices of  other players]{.hii}.
  
:::

::: {.notes}
  - In EC311 we look at the consumption choices consumers make when constrained by a budget
  - In this class, other players set the constraints as well as physical limitations
  - Think of the toilet paper example: would I want to store a whole garage's worth if I wasn't worried about everyone else doing the same?
:::
...
::: {.incremental}
  ...
  * a [mapping]{.hi} that tells us how combinations of strategies lead to different outcomes
...
. . .
  ...
  1. [Tea 4](https://maps.app.goo.gl/zCVTUnaaYLD1Rwaw6)
  2. [Day & Night](https://www.daynightboba.com/) 
  3. [Bobahead]() 
  4. No boba
  5. [Rabbit Hole](http://therabbitholeteabar.com/) 
