...
::: {.incremental}
  ...
  * [Example]{.hi}: Rock, paper, scissors
:::
...
while also thinking about what your opponent is thinking you will do.
...
Many games you are familiar with have distinct *winners* and *losers*.
...
When the *total payoffs of all players sum to 0* ^[or sum to some constant]
  ...
  * Example: Soccer, Scramble for Africa
