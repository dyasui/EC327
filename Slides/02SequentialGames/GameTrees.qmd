...
A [Game Tree]{.h} consists of:

  * One or more [decision nodes]{.hi} for each player

    + starting with one [initial node]{.hii}

  * [Branches]{.hi} coming from each decision node which represent available *actions*

  * The game ends in any of the multiple [terminal nodes]{.hi}
