...
Another term for the [rollback solution]{.hi} is [subgame perfect Nash equilibrium]{.hi}
  ...
  * In this equilibrium, [neither player has regrets]{.h} about any actions they take (or would take) as part of their strategy
...
digraph D {
  ...
  A1->B2[label="2",arrowhead=normal];
