...
# Activity 2: Survivor Challenge

## Watch the clip

{{< video https://youtu.be/aonCsvi0LKc width="800" height="450" fig-align="center" >}}
...
In your teams briefly discuss the following:
  ...
  * Is the game solved meaning that the winner can be correctly predicted from any point in the game? 
  
    + If so, should the first or second team always win?
  
  * Were there more errors in the first games played than the last games played?
