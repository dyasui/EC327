...
\begin{parts}
  \part[4] Suppose that hunter 2 chooses to hunt deer with effort level $e_2=2$.
  Draw out hunter 1's payoffs for both their $Deer$ and $Rabbit$ strategies
  as a function of their own level of effort.
  \begin{solution}
    See graph below:
  ...
  \part[2] What is hunter 1's best response to hunter 2 choosing $e_2=2$?

  \part[4] Is there a Nash equilibrium where both hunt Deer?
