...
\begin{parts}
  ...
  \begin{solution}
    (Bottom, Right) is the only pure-strategy Nash
  \end{solution}
  \part[4]
...
Consider the following game:\footnote{Dixit, Skeath, \& McAdams, \textit{Games of Strategy}, 4th Edition}
  ...
  \begin{parts}
    ...
    \begin{solution}
      If $x<1$, then No is a dominant strategy
      and (No, No) is the unique Nash.
    \end{solution}
    \part[4]
    ...
    on the same graph.
    Label all Nash equilibriua in pure and mixed strategies.
    \part[4]
