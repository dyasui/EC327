...
\begin{parts}
  ...
  then the equilibrium of the game changes to ${$ Transgress, (Sanction if Transgress, Don't Punish if Don't Transgress) $}$
  because now Player 2 it is rational for Player 2 to Sanction after a Transgression, 
